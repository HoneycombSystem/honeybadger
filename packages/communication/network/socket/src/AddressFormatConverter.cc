...
{
sockaddr_in convertEndpointToSockaddrIn(const common::types::Endpoint &endpoint)
{
...
sockaddr_in6 convertEndpointToSockaddrIn6(const common::types::Endpoint &endpoint)
{
